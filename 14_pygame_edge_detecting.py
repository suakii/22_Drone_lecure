    ...
    def run(self):
        ...
        while not should_stop:
            ...
            if frame is not None:
                ...
                detect_edge_frame = self.find_edge(frame_copy)
                frame = frame.swapaxes(0, 1)
                detect_edge_frame = detect_edge_frame.swapaxes(0, 1)

                self.screen.blit(pygame.surfarray.make_surface(frame), [0, 0])
                self.screen.blit(pygame.surfarray.make_surface(detect_edge_frame), [640, 0])
